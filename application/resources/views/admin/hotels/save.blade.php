...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            @if($action == 'create')
                {!! Form::open(['route' => 'hotels.store', 'method' => 'POST', 'autocomplete' => 'off']) !!}
            @else
                {!! Form::open(['route' => ['hotels.update',@$data->id], 'method' => 'PUT', 'autocomplete' => 'off']) !!}
            @endif
                ...
                <a class="btn btn-danger" href="{{ route('hotels.index') }}"><i class="fa fa-times"></i> Cancelar</a>
            {!! Form::close() !!}
        </div>
    </div>
@stop